...
- name: Google Site Verification API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-organizations/google-site-verification/master/_listings/google-site-verification/webresource-id-put.md
x-common:
- type: x-code
